...
export const PACKAGES: readonly PackageEntry[] = [
  ...
  },
  {
    ...
    title: 'Visualizer',
    tagline: 'WebGL2 dashboard driven by in-browser entropy.',
    group: 'tools',
  },
  {
    id: 'oracle',
    ...
    title: 'Oracle',
    tagline: 'I-Ching, Tarot, runes and geomancy from an entropy stream.',
    group: 'frontier',
  },
  {
    id: 'rate',
    pkg: '@mindpeeker/rate',
    title: 'Rate',
    tagline: 'Malcolm Rae base-44 radionic rate cards as SVG.',
    group: 'frontier',
  },
  {
    id: 'field',
    ...
    title: 'Field',
    tagline: 'Spatial point fields with attractor/void detection.',
    group: 'frontier',
  },
  {
    id: 'negentropy',
    ...
    title: 'Negentropy',
    tagline: 'Randomness health estimators and GCP statistics.',
    group: 'randomness',
  },
  {
    id: 'entropy',
    ...
    title: 'Entropy',
    tagline: 'Provider-pluggable QRNG/TRNG/beacon randomness.',
    group: 'randomness',
  },
  {
    id: 'flow',
  ...
  },
  {
    ...
    pkg: '@mindpeeker/psi',
    title: 'Psi',
    tagline: 'PEAR-style mind-matter protocols and Bayes factors.',
    group: 'frontier',
  },
  {
    id: 'scan',
    pkg: '@mindpeeker/scan',
    title: 'Scan',
    tagline: 'Honest radionic scanning with a chance-deviation null.',
    group: 'frontier',
  },
  {
    id: 'vdf',
    pkg: '@mindpeeker/vdf',
    title: 'VDF',
    tagline: 'Pietrzak verifiable delay function over RSA-2048.',
    group: 'randomness',
  },
]
