import type { PsiError } from '../errors.js'
 ...
 * ignores the signal. A pull that settles after the abort is still observed
 * (its rejection is handled), and the listener is removed once it settles.
 */
